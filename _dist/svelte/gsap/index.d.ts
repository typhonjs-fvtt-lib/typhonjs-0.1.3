...
import * as _runtime_svelte_store_position from '@typhonjs-fvtt/runtime/svelte/store/position';
 ...
 *
 * @param {import('@typhonjs-fvtt/runtime/svelte/store/position').TJSPosition}   params.position - A position instance.
 *
