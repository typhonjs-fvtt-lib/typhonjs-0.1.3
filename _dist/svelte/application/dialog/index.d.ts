import * as _typhonjs_fvtt_runtime_svelte_application from '@typhonjs-fvtt/runtime/svelte/application';
...
declare class TJSDocumentCreate extends TJSDialog {
     ...
     *
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').SvelteApplicationOptions} [context.options] - Rest of options
     *        to pass to TJSDialog / Application.
     *
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').TJSDialogOptions} [dialogData] - Optional data to modify dialog.
     *
    ...
    static show(documentCls: object, data?: object, { parent, pack, renderSheet, ...options }?: {
        ...
        pack?: object;
        renderSheet?: boolean;
        options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions;
    }, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions): Promise<foundry.abstract.Document | null>;
    /**
     * Create a new Document of the type specified by `documentCls` by rendering a dialog window to provide basic
     * creation details.
     *
     ...
     * @param {boolean} [context.renderSheet] - Render the sheet for the new document.
     *
     * @param {Partial<import('@typhonjs-fvtt/runtime/svelte/application').SvelteApplicationOptions>} [context.options] - Rest of options
     * to pass to TJSDialog / Application.
     *
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').TJSDialogOptions} [dialogData] - Optional data to modify dialog.
     */
    constructor(documentCls: object, data?: object, { parent, pack, renderSheet, ...options }?: {
        ...
        pack?: object;
        renderSheet?: boolean;
        options?: Partial<_typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions>;
    }, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions);
}
...
declare class TJSDocumentDelete extends TJSDialog {
     ...
     *
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').SvelteApplicationOptions} [opts.options] - Rest of options to pass to
    ...
    static show(document: foundry.abstract.Document, { context, ...options }?: {
        context?: object;
        options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions;
    }, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions): Promise<foundry.abstract.Document | boolean | null>;
    /**
     * @param {foundry.abstract.Document} document - Document to delete.
     *
     * @param {object} [opts] - Additional context options or dialog positioning options.
     ...
     * @param {object} [opts.context] - DocumentModificationContext.
     *
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').SvelteApplicationOptions} [opts.options] - Rest of options to pass to TJSDialog / Application.
     *
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').TJSDialogOptions} [dialogData] - Optional data to modify dialog.
     */
...
declare class TJSDocumentDialog {
     ...
     *
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').SvelteApplicationOptions} [options] - Rest of options to pass to
     *        TJSDialog / Application.
     *
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').TJSDialogOptions} [dialogData] - Optional data to modify dialog.
     *
     ...
     */
    static configureOwnership(document: foundry.abstract.Document, options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions): Promise<foundry.abstract.Document | null>;
    /**
     * Create a new Document of the type specified by `documentCls` by rendering a dialog window to provide basic
     * creation details.
     *
     ...
     * @param {boolean} [context.renderSheet] - Render the sheet for the new document.
     *
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').SvelteApplicationOptions} [context.options] - Rest of options to pass
     ...
     * @param {object} [opts.context] - DocumentModificationContext.
     *
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').SvelteApplicationOptions} [opts.options] - Rest of options to pass
     *        to TJSDialog / Application.
     *
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').TJSDialogOptions} [dialogData] - Optional data to modify dialog.
     *
     ...
     *
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').SvelteApplicationOptions} [options] - Options to pass to TJSDialog /
     *        Application.
     *
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').TJSDialogOptions} [dialogData] - Optional data to modify dialog.
     *
     ...
     */
    static folderCreate(folderData: object, options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions): Promise<globalThis.Folder | null>;
    /**
     ...
     *          cancelling or 'null' if the user closed the dialog via `<Esc>` or the close header button.
     */
    static folderDelete(document: globalThis.Folder, options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions): Promise<globalThis.Folder | boolean | null>;
    /**
    ...
    static folderExport(document: globalThis.Folder, { pack, merge, keepId, ...options }?: {
        ...
        keepId?: boolean;
        options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions;
    }, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions): Promise<globalThis.CompendiumCollection | boolean | null>;
    /**
     ...
     *          cancelling or 'null' if the user closed the dialog via `<Esc>` or the close header button.
     */
    static folderRemove(document: globalThis.Folder, options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions): Promise<globalThis.Folder | boolean | null>;
    /**
     ...
     *          'false' for cancelling or 'null' if the user closed the dialog via `<Esc>` or the close header button.
     */
    static folderRolltable(document: globalThis.Folder, options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions): Promise<globalThis.RollTable | boolean | null>;
    /**
     ...
     */
    static folderUpdate(document: globalThis.Folder, options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions): Promise<globalThis.Folder | null>;
    /**
     ...
     *          button.
     */
    static importFromJSON(document: foundry.abstract.Document, options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions): Promise<foundry.abstract.Document | boolean | null>;
}
...
declare class TJSDocumentImport extends TJSDialog {
     ...
     *          button.
     */
    static show(document: foundry.abstract.Document, options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions): Promise<foundry.abstract.Document | boolean | null>;
    /**
     * Render an import dialog for updating the data related to this Document through an exported JSON file
     *
     * @param {foundry.abstract.Document} document - The document to import JSON to...
     ...
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').TJSDialogOptions} [dialogData] - Optional data to modify dialog.
     */
    constructor(document: foundry.abstract.Document, options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions);
}
...
declare class TJSDocumentOwnership extends TJSDialog {
     ...
     */
    static show(document: foundry.abstract.Document, options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions): Promise<foundry.abstract.Document | null>;
    /**
     * @param {foundry.abstract.Document} document - Document instance to modify.
     *
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').SvelteApplicationOptions} [options] - Rest of options to pass to
...
declare class TJSFolderCreateUpdate extends TJSDialog {
     ...
     * @returns {Promise<globalThis.Folder|null>} The modified Folder or null if the dialog is closed.
     */
    static showUpdate(document: globalThis.Folder, options?: object, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions): Promise<globalThis.Folder | null>;
    /**
     * Updates an existing Folder by rendering a dialog window with basic details.
     *
     * @param {globalThis.Folder} document - The folder to edit.
     ...
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').TJSDialogOptions} [dialogData] - Optional data to modify dialog.
     */
    constructor(document: globalThis.Folder, options?: object, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions);
}
...
declare class TJSFolderDelete extends TJSDialog {
     ...
     *          cancelling or 'null' if the user closed the dialog via `<Esc>` or the close header button.
     */
    static show(document: globalThis.Folder, options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions): Promise<globalThis.Folder | boolean | null>;
    /**
     * Deletes a folder and does delete sub-folders / documents.
     *
     * @param {globalThis.Folder} document - Folder to delete.
     ...
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').TJSDialogOptions} [dialogData] - Optional data to modify dialog.
     */
    constructor(document: globalThis.Folder, options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions);
}
...
declare class TJSFolderRolltable extends TJSDialog {
     ...
     *          'false' for cancelling or 'null' if the user closed the dialog via `<Esc>` or the close header button.
     */
    static show(document: globalThis.Folder, options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions, dialogData?: _typhonjs_fvtt_runtime_svelte_application.TJSDialogOptions): Promise<globalThis.RollTable | boolean | null>;
    /**
     * @param {globalThis.Folder} document - Folder to create roll table from...
     *
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').SvelteApplicationOptions} [options] - Options to pass to TJSDialog /
