import * as _typhonjs_svelte_runtime_base_svelte_util from '@typhonjs-fvtt/runtime/svelte/util';
import { TJSSvelteConfig } from '@typhonjs-fvtt/runtime/svelte/util';
import * as _typhonjs_svelte_runtime_base_svelte_store_web_storage from '@typhonjs-fvtt/runtime/svelte/store/web-storage';
...
import { TJSPositionDataExtended, TJSPosition } from '@typhonjs-fvtt/runtime/svelte/store/position';
import * as _typhonjs_svelte_runtime_base_util_browser from '@typhonjs-fvtt/runtime/util/browser';
...
declare class SvelteApplication {
     ...
     * @inheritDoc
     */
    constructor(options?: _typhonjs_fvtt_runtime_svelte_application.SvelteApplicationOptions);
    /**
