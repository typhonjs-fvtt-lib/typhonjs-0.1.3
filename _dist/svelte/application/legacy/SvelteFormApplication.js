...
export class SvelteFormApplication extends FormApplication
{
    ...
    *
    * @type {import('@typhonjs-fvtt/runtime/svelte/application').MountedAppShell[] | null[]} Application shell.
    */
    ...
    *
    * @type {import('@typhonjs-fvtt/runtime/svelte/application').SvelteData[]}
    */
   #svelteData = [];
