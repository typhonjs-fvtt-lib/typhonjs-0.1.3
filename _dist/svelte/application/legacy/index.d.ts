...
import * as _typhonjs_svelte_runtime_base_svelte_store_position from '@typhonjs-fvtt/runtime/svelte/store/position';
...
declare class SvelteFormApplication {
     ...
     *
     * @returns {import('@typhonjs-fvtt/runtime/svelte/application').SvelteReactive} The reactive accessors & Svelte stores.
     */
    get reactive(): _typhonjs_fvtt_runtime_svelte_application.SvelteReactive;
    /**
     * Returns the application state manager.
     *
     * @returns {import('@typhonjs-fvtt/runtime/svelte/application').ApplicationState<SvelteFormApplication>} The application state
     *          manager.
     */
    get state(): _typhonjs_fvtt_runtime_svelte_application.ApplicationState<SvelteFormApplication>;
    /**
     * Returns the Svelte helper class w/ various methods to access mounted Svelte components.
     *
     * @returns {import('@typhonjs-fvtt/runtime/svelte/application').GetSvelteData} GetSvelteData
     */
    get svelte(): _typhonjs_fvtt_runtime_svelte_application.GetSvelteData;
    /**
     ...
     *
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').MountedAppShell} [mountedAppShell] - The mounted app shell elements.
     */
    onSvelteMount(mountedAppShell?: _typhonjs_fvtt_runtime_svelte_application.MountedAppShell): void;
    /**
     ...
     * @param {import('@typhonjs-fvtt/runtime/svelte/application').MountedAppShell} [mountedAppShell] - The mounted app shell elements.
     */
    onSvelteRemount(mountedAppShell?: _typhonjs_fvtt_runtime_svelte_application.MountedAppShell): void;
    /**
