import * as _runtime_math_gl_matrix from '@typhonjs-fvtt/runtime/math/gl-matrix';
import { Vec3, Mat4 } from '@typhonjs-fvtt/runtime/math/gl-matrix';
import * as svelte_store from 'svelte/store';
import * as _runtime_util_animate from '@typhonjs-fvtt/runtime/util/animate';
...
declare class TJSTransformData {
    ...
    /**
     * @returns {import('@typhonjs-fvtt/runtime/math/gl-matrix').Vec3[]} The transformed corner points as Vec3 in screen space.
     */
    get corners(): Vec3[];
    /**
    ...
    get css(): string;
    /**
     * @returns {import('@typhonjs-fvtt/runtime/math/gl-matrix').Mat4} The transform matrix.
     */
    get mat4(): Mat4;
    /**
     * @returns {import('@typhonjs-fvtt/runtime/math/gl-matrix').Mat4[]} The pre / post translation matrices for origin translation.
     */
...
declare class TJSTransforms {
     ...
     *
     * @param {import('@typhonjs-fvtt/runtime/math/gl-matrix').Mat4}  [output] - The output mat4 instance.
     *
     * @returns {import('@typhonjs-fvtt/runtime/math/gl-matrix').Mat4} Transform matrix.
     */
...
declare class AnimationAPI {
     ...
     *
     * @returns {import('@typhonjs-fvtt/runtime/util/animate').TJSBasicAnimation[]} All currently scheduled animation controls for
     ...
     *
     * @returns {import('@typhonjs-fvtt/runtime/util/animate').TJSBasicAnimation}  A control object that can cancel animation and
...
declare class AnimationGroupAPI {
     ...
     *
     * @returns {import('@typhonjs-fvtt/runtime/util/animate').TJSBasicAnimation} Basic animation control.
     */
